...
import { getComponentName } from '../_util/props-util'
...
export default {
  ...
  render () {
    ...
    const { prefixCls = 'ant-list', actions, extra, className, ...others } = this.props
    ...
    $slots.default.forEach((element) => {
      if (element && element.componentOptions &&
        getComponentName(element.componentOptions) === 'Meta') {
